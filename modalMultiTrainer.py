...
CHECKPOINT_DIR = f"{VOLUME_ROOT}/outputs/checkpointsMM"
GRAPH_DIR = f"{VOLUME_ROOT}/outputs/graphsMM"
MODEL_DIR = f"{VOLUME_ROOT}/outputs/modelsMM"
PREDS_DIR = f"{VOLUME_ROOT}/outputs/predictionsMM"
...
model_to_pretrained_model = {"CNN":'/mnt/brats-data/outputs/models/CNN_SingMod_TC_T1ceT1_model_final.pt',
                                "FullTransUNet":'/mnt/brats-data/outputs/modelsMM/model_final.pt'}
