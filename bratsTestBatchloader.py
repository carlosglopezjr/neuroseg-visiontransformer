...
"""
BraTSTestBatchDataset loader that finds all cases from directory and stacks modalities as classes
so they can be interpreted as channels. Made for test batch when calling executable

"""

class BraTSTestBatchDataset(Dataset):
...
def create_brats_test_dataloader(mode,
                              data_dir,
                              modalities,
    ...
    return InfiniteDataLoader(test_loader)